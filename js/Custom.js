            ...
            $('#reindeer').animate({
                ...
                $('#reindeer').animate({
                    ...
                    $(".message").typed({
                        strings: [
                            "<<< Merry Christmas >>>",
                            "Mong rằng những ánh sáng lung linh của Noel sẽ mang đến cho bạn sự bình an hạnh phúc và thật nhiều may mắn. Chúc mọi người có một mùa noel thật ấm áp nha.",
                        ],
                        typeSpeed: 1,
                        startDelay: 500,
                        backSpeed: 50,
